...
class ViewController: NSViewController {
    ...
    override func viewDidLoad() {
        ...
        let button1 = NSButton.init(title: "click", target: self, action: #selector(button1Clicked(_:)))
        ...
        let button2 = NSButton.init(title: "click", target: self, action: #selector(button2Clicked(_:)))
        ...
        let button3 = NSButton.init(title: "click", target: self, action: #selector(button3Clicked(_:)))
